 ...
 * @since 1.0.0
 */
public class RecursionAboutFileFinder {

    public static void main(String[] args) {

        RecursionAboutFileFinder idd = new RecursionAboutFileFinder();
        List<File> files = idd.find("/Users/Hong/IdeaProjects/java-study", 2, Arrays.asList("xml", "MD"));
        for (File file : files) {
     ...
     * @return 查找结果集合
     */
    public List<File> find(String path, Integer depth, List<String> typeList) {
