...
public class RandomNameUtil {
    ...
    public static String getRandomName() {
        return NAME_TOP500.get(new Random().nextInt(NAME_TOP500.size()));
    }
